...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/gentle-pine-ac14
```

A live public deployment of this template is available at [https://gentle-pine-ac14.templates.workers.dev](https://gentle-pine-ac14.templates.workers.dev)
